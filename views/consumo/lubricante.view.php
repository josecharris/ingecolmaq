...
<head>
  ...
  <title>Consumo de lubricante</title>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
    <div class="card" style="width: 80%; margin: 0 auto; color: black;">
      <div class="card-body">
        ...
        <div class="form-group">
            <label for="exampleFormControlSelect1"><strong>Marca*</strong></label>
            <select class="form-control" id="slc_marca" name="slc_marca" 
            onchange="cambio_unitario2('slc_marca','otra_marca')">
                <option value="default">- Seleccione la marca -</option>
                <option value="default">PETROBRAS</option>
                <option value="default">GULF</option>
                <option value="default">LIQUI MOLY </option>
                <option value="default">CATERPILLAR</option>
                <option value="default">KOMATSU</option>
                <option value="otro">Otro</option>
            </select><br>
            <div id="otra_marca" class="ocultar">
              <label for="exampleFormControlSelect1"><strong>Escriba la nueva marca*</strong></label>
              <input type="text" class="form-control" id="new_marca" name="new_marca">
            </div>                           
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="exampleFormControlSelect1">Numero del recibo generado tras el tanqueo*</label>
