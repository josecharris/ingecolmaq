            ...
            <div class="accordion-item-body-content">
              <div class="card" id="seccion_equipos">
                <div class="card-body">
                  <h2>Pulpo</h2>
                  <div class="form-group" style="margin-top: 15px;">
                      <label for="exampleFormControlSelect1">Verificar el estado de pasadores, bujes y uñas. Identifique fisuras y desajustes*</label>
                  ...
                  <div class="form-group">
                      <label for="exampleFormControlSelect1">Verificar sistema hidraulico, accionamiento, Estado de cilindros, racores y mangueras.*</label>
            ...
            <div class="accordion-item-body-content">
              <div class="card">
                <div class="card-body">
                  ...
                  <br>
                  <div class="form-group">
                      <label for="exampleFormControlSelect1">Verificar accionamiento y agarre del iman*</label>
                      <select class="form-control" id="selec_iman" onchange="cambio_unitario('selec_iman','card-anexo20');">
                        <option value="default">- Seleccione una opción -</option>
                        <option value="C">Conforme (C)</option>
                        <option value="NC">No conforme (NC)</option>
                        <option value="NA">No aplica (NA)</option>
