            ...
            <div class="accordion-item-body-content">
              <div class="card" id="seccion_equipos">
                <div class="card-body">
                  ...
                  <div class="form-group" style="margin-top: 15px;">
                      <label for="exampleFormControlSelect1">Verificar estado de chopos, bujes barras estabilizadora, bujes vigas o eje muerto*</label>
                      <select class="form-control" id="slc_suspencion1" onchange="cambio_doble('slc_suspencion1','slc_suspencion2','card-anexo21');">
                        <option value="default">- Seleccione una opción -</option>
                        <option value="C">Conforme (C)</option>
                        <option value="NC">No conforme (NC)</option>
                        <option value="NA">No aplica (NA)</option>
                  ...
                  <div class="form-group">
                      <label for="exampleFormControlSelect1">Verificar estado de rotulas y pasadores articulacion,  rotulas y pasadores cilindros levante, direccion y suspension delantera*</label>
                      <select class="form-control" id="slc_suspencion2" onchange="cambio_doble('slc_suspencion1','slc_suspencion2','card-anexo21');">
                        <option value="default">- Seleccione una opción -</option>
                        <option value="C">Conforme (C)</option>
                        <option value="NC">No conforme (NC)</option>
                        <option value="NA">No aplica (NA)</option>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" id="select_volco" onchange="cambio_unitario('select_volco','card-anexo50');">
                        <option value="default">- Seleccione una opción -</option>
                        <option value="C">Conforme (C)</option>
                        <option value="NC">No conforme (NC)</option>
                        <option value="NA">No aplica (NA)</option>
